...
The complete 10-file mapping is recorded in
[`codex/overnight-workflows/install-manifest.json`](codex/overnight-workflows/install-manifest.json).
It installs:

| Canonical install source | Installed path inside `overnight-workflows` | Repository navigation stub |
|---|---|---|
| `codex/overnight-workflows/SKILL.md` | `SKILL.md` | — |
| `codex/overnight-workflows/agents/openai.yaml` | `agents/openai.yaml` | — |
| `plugins/large-redesign-parallel-branch-collision-audit/SKILL.md` | `references/workflows/large-redesign-parallel-branch-collision-audit.md` | `codex/overnight-workflows/references/workflows/large-redesign-parallel-branch-collision-audit.md` |
| `plugins/overnight-insight-discovery/SKILL.md` | `references/workflows/overnight-insight-discovery.md` | `codex/overnight-workflows/references/workflows/overnight-insight-discovery.md` |
| `plugins/overnight-multi-issue-implementation/SKILL.md` | `references/workflows/overnight-multi-issue-implementation.md` | `codex/overnight-workflows/references/workflows/overnight-multi-issue-implementation.md` |
| `plugins/overnight-review-client-delivery/SKILL.md` | `references/workflows/overnight-review-client-delivery.md` | `codex/overnight-workflows/references/workflows/overnight-review-client-delivery.md` |
| `plugins/overnight-review-panel-blocked-reviewer-reads-as-clean/SKILL.md` | `references/workflows/overnight-review-panel-blocked-reviewer-reads-as-clean.md` | `codex/overnight-workflows/references/workflows/overnight-review-panel-blocked-reviewer-reads-as-clean.md` |
| `plugins/schedule-poll-orchestrator-pattern/SKILL.md` | `references/workflows/schedule-poll-orchestrator-pattern.md` | `codex/overnight-workflows/references/workflows/schedule-poll-orchestrator-pattern.md` |
| `plugins/subagent-review-tier-calibration-for-overnight-pr-chains/SKILL.md` | `references/workflows/subagent-review-tier-calibration-for-overnight-pr-chains.md` | `codex/overnight-workflows/references/workflows/subagent-review-tier-calibration-for-overnight-pr-chains.md` |
| `plugins/overnight-multi-issue-implementation/references/large-live-queue-orchestration.md` | `references/workflows/references/large-live-queue-orchestration.md` | `codex/overnight-workflows/references/workflows/references/large-live-queue-orchestration.md` |

Copy all 10 canonical sources to their exact installed paths, then compare
all 10 source/install SHA-256 digests. The 8 tracked route stubs are
repository navigation files, not install sources; validate that each link
resolves to the canonical source named in the manifest.
