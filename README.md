...
`scripts/validate_panel_inputs.py --manifest panel.jsonl`
reproduces those joins and rejects omissions or drift; `--self-test` runs the
committed omission and mutation controls.
