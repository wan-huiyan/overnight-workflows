...
The complete four-file mapping is recorded in
...
Copy all four canonical sources to their exact installed paths, then compare
all four source/install SHA-256 digests. The two tracked route stubs are
